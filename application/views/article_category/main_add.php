            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-7">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <?php echo form_open('article/category/main/add/perform',$attr_pic);?>
                        <table class="table table-bordered table-condensed" style="background-color:#FFFFFF;">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="acm_name" class="form-control" required="required"/></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-cubes"></i>&nbsp;排序</td>
                                <td><input type="number" name="acm_sort_id" class="form-control" required="required" max="99" min="0" value="0"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <center>
                                        ...
                                        <button type="button" onclick="window.location.href = '<?php echo base_url('article/category/main/admin');?>';">返回</button>
                                    </center>
                                </td>
                            </tr>
                        </table>
