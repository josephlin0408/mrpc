            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-7">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <?php echo form_open('article/category/main/update/perform',$attr_pic);?>
                        <table class="table table-bordered table-condensed" style="background-color:#FFFFFF;">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="acm_name" class="form-control" required="required" value="<?=$category_main['acm_name'];?>"/></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-cubes"></i>&nbsp;排序</td>
                                <td><input type="number" name="acm_sort_id" class="form-control"
                                           required="required" value="<?=$category_main['acm_sort_id'];?>"
                                           max="99" min="0"
                                        />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="acm_status" id="" class="form-control">
                                        <option value="0">顯示</option>
                                        <option value="1" <?php if($category_main['acm_status']=='1')echo 'selected';?>>不顯示</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <input type="hidden" name="acm_id" value="<?=$category_main['acm_id'];?>"/>
                                    <input class="btn btn-success btn-sm" type="submit" value="確定編輯"/>
                                    <button class="btn btn-inverse btn-sm"  type="button" onclick="window.location.href = '<?php echo base_url('article/category/main/admin');?>';">返回</button>
                                </td>
                            </tr>
                        </table>
                        <?php echo form_close();?>
