            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-7">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <?php echo form_open('offline/store/add/perform',$attr_pic);?>
                        <table class="table table-bordered table-condensed" style="background-color:#FFFFFF;">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="ofs_name" class="form-control" required="required"/></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-cubes"></i>&nbsp;商店地址</td>
                                <td><input type="text" name="ofs_addr" class="form-control" required="required"/></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-list-alt"></i>&nbsp;說明</td>
                                <td><textarea name="ofs_desc" id="" cols="30" rows="10" class="form-control" required="required"></textarea></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-list-ol"></i>&nbsp;圖示</td>
                                <td>
                                    <input type="file" class="form-control" name="ofs_source"/>
                                </td>
                            </tr>
                            <tr>
