                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            echo form_open_multipart('lesson/update/'.$lesson['lesson_id'], $attributes);
                                ;?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="lesson_category_id" class="form-control" id="">
                                        ...
                                        <option value="<?php echo $unit['lesson_category_id'];?>" <?php if($lesson['lesson_category_id']==$unit['lesson_category_id'])echo 'selected';;?>>
                                            <?php echo $unit['lesson_category_name'];?>
                                        </option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>報名起始時間</label>
                                    <input type="datetime-local" class="form-control" name="lesson_booking_start_time"
                                           value="<?php echo date('Y-m-d',strtotime($lesson['lesson_booking_start_time'])).'T'.date('H:i',strtotime($lesson['lesson_booking_start_time']));?>"/>
                                </div>
                                <div class="form-group">
                                    <label>報名結束時間</label>
                                    <input type="datetime-local" class="form-control" name="lesson_booking_end_time"
                                           value="<?php echo date('Y-m-d',strtotime($lesson['lesson_booking_end_time'])).'T'.date('H:i',strtotime($lesson['lesson_booking_end_time']));?>"
                                           "/>
                                </div>
                                <div class="form-group">
                                    <label>報名人數限制</label>
                                    <input type="number" class="form-control" name="lesson_booking_number_limit" value="<?php echo $lesson['lesson_booking_number_limit'];?>"/>
                                </div>
                                <div class="form-group">
                                    <label>課程標價</label>
                                    <input type="number" class="form-control" name="lesson_tag_price" value="<?php echo $lesson['lesson_tag_price'];?>"/>
                                </div>
                                <div class="form-group">
                                    <label>是否售票</label>
                                    <select name="lesson_sell_status" class="form-control" id="">
                                        <option value="0">否</option>
                                        <option value="1" <?php if($lesson['lesson_sell_status']==1)echo 'selected';?>>是</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>連結網址</label>
                                    <input type="text" class="form-control" name="lesson_link"
                                           ...
                                           data-parsley-maxlength="150"
                                            value="<?php echo $lesson['lesson_link'];?>"
                                        />
                                </div>
                                <div class="form-group">
                                    <label>Meta</label>
                                    <input type="text" class="form-control" name="lesson_meta"
                                           data-parsley-trigger="change"
                                           data-parsley-maxlength="150"
                                           value="<?php echo $lesson['lesson_meta'];?>"
                                        />
                                </div>
                                <div class="form-group">
                                    <label>原始課程預覽圖：</label>
                                    <img src="<?php echo base_url().'uploads/'.$lesson['lesson_source'];?>" alt="" class="img_size"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="lesson_open_status" class="form-control" id="">
                                        ...
                                        <option value="1" <?php if($lesson['lesson_open_status']==1)echo 'selected';?>>僅會員可以參加</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>課程顯示狀態</label>
                                    <select name="lesson_status" class="form-control" id="">
                                        ...
                                        <option value="1" <?php if($lesson['lesson_status']==1)echo 'selected';?>>不顯示</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lesson_lecturer"
                                           data-parsley-trigger="change"
                                           data-parsley-maxlength="150"
                                           value="<?php echo $lesson['lesson_lecturer'];?>"
                                        />
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lesson_address"
                                           data-parsley-trigger="change"
                                           data-parsley-maxlength="150"
                                            value="<?php echo $lesson['lesson_address'];?>"
                                        />
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lesson_latitude"
                                           ...
                                           value="<?php echo $lesson['lesson_latitude'];?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lesson_longitude"
                                           data-parsley-trigger="change"
                                           data-parsley-maxlength="100"
                                           value="<?php echo $lesson['lesson_longitude'];?>"
                                           placeholder="例如 : 121.582363"/>
                                </div>
                                <div class="form-group">
                                    <label>內文編輯器</label>
                                    <div class="form-group">
                                        <textarea class="summernote" name="lesson_content"><?php echo $lesson['lesson_content'];?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <?php echo form_hidden('switch','update_this_lesson');?>
                                    <?php echo form_hidden('ori_img_source',$lesson['lesson_source']);?>
