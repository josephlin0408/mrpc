...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">更新產品庫存</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="panel-body">
                    ...
                    <form method="post" accept-charset="utf-8" id="search">
                        ...
                        <table class="table table-hover" style="margin-bottom: 10px;">
                            <tbody>
                            <tr>
                                <td><label>剩餘庫存</label></td>
                                <td>
                                    <input type="text" value="<?=isset($data['remain_count']) ? $data['remain_count'] : "" ?>" name="remain_count" class="search_input form-control" required>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
