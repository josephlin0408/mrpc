    ...
    <div class="col-lg-12">
        ...
        <div class="table-responsive" >
            <table class='table table-hover' style='width:85%;'>
                ...
                <?php echo form_open('prospect/view/'.$member_item['member_id']) ?>
                    <input name='member_id' value='<?=$member_item['member_id']?>' type='hidden'>
                    ...
                    <tr><th style="width:20%"><input value="送出修改" type="submit" class="btn btn-primary">
                            <a href="<?= base_url();?>prospect/" class='btn btn-primary'>返回</a></th>
                        <td></td></tr>
                </form>
            </table>
        </div>
