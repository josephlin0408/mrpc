                        ...
                        <div class="col-lg-12">
                            ...
                            <? $attributes = array('id' => 'new_article','data-parsley-validate'=>'');
                               echo form_open('email/create/', $attributes);?>
                                <input type="hidden" name="template_hash_id" value="<?=sha1(rand());?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <?foreach($category AS $unit):?>
                                        <div class="col-lg-3"><input type="radio" name="template_task_category" value="<?=$unit['category_id']?>"> <?=$unit['category_name']?> &nbsp;</div>
                                    <?endforeach?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>內文編輯器</label>
                                    <div class="form-group">
                                        <textarea class="summernote" name="template_content"></textarea>
                                    </div>
                                </div>
