                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                echo form_open('admin/brand/new', $attributes);?>
                                <input type="hidden" name="brand_hash_id" value="<?=$hash_id;?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea class="summernote" name="brand_description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-default">送出</button>
                                    <a href="<?=base_url()."admin/dog/food"?>" onclick="return confirm('請再次確認，返回後所有圖文不會儲存。')" class="btn btn-default">返回</a>
                                </div>
                                </form>
                            </div>
                            <!-- /.col-lg-6 (nested) -->
