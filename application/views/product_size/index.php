...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">產品尺寸 <a class="btn btn-default" href="<?=base_url()?>product/item/update/<?=$product_idx?>">回產品管理</a>  <a class="btn btn-primary" href="<?=base_url()?>product/size/create/<?=$product_idx?>">新增</a></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables">
                                ...
                                foreach ($data as $single):
                                    ...
                                    <td style="width: 350px">
                                        <a class="btn btn-default" href="<?=base_url()?>product/size/update/<?=$product_idx?>/<?=$single['idx']?>">編輯</a>
                                        <a class='btn btn-default' onclick='return confirm("確定停用嗎？")' href='<?=base_url()?>product/size/delete/<?=$product_idx?>/<?=$single['idx']?>'>停用</a>
                                    </td>
                                    <?php echo "</tr>";
                                endforeach;?>
                                </tbody>
