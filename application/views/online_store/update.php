            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-7">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <?php echo form_open('online/store/update/perform',$attr_pic);?>
                        <table class="table table-bordered table-condensed" style="background-color:#FFFFFF;">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="os_name" class="form-control" required="required" value="<?=$os_store['os_name'];?>"/></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-cubes"></i>&nbsp;連結</td>
                                <td><input type="text" name="os_link" class="form-control" required="required" value="<?=$os_store['os_link'];?>"/></td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-list-ol"></i>&nbsp;圖示</td>
                                <td>
                                    <?php if(!empty($os_store['os_source']))echo '<img src="' . base_url() . 'uploads/' . $os_store['os_source'].'" '.'class="img-thumbnail img_size">';?>
                                    <input type="file" name="os_source" style="display: inline"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="os_status" id="" class="form-control">
                                        ...
                                        <option value="1" <?php if($os_store['os_status']=='1')echo 'selected';?>>不顯示</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <center>
                                        <input type="hidden" name="os_source_origin" value="<?=$os_store['os_source'];?>"/>
                                        <input type="hidden" name="os_id" value="<?=$os_store['os_id'];?>"/>
