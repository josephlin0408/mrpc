...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Coupon Code 折扣管理</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Coupon Code <small>折扣管理</small></h1>
    <div class="email-btn-row hidden-xs">
        <button data-toggle="modal" data-target="#modal_create" class='btn btn-inverse btn-sm'><i class="fa fa-plus"></i> 新增</button>
    </div>
    <!-- end page-header -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="data_table">
                            ...
                            foreach ($coupon as $item): ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><button style="margin: 3px 0" class="btn btn-success btn-sm btn-editor"
                                        ...
                                        >編輯</button>
                                        <a class="btn btn-default btn-sm" onclick="return confirm('確定刪除嗎？')" href="<?=base_url()?>coupon/delete/<?=$item['coupon_id']?>" >刪除</a></td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
                        </table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" id="btn_create_submit">儲存</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal_update" tabindex="-1" role="dialog" aria-labelledby="modal_update">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">關閉</button>
                <button type="button" class="btn btn-success btn-sm" id="btn_update_submit">更新</button>
            </div>
        </div>
    </div>
</div>
